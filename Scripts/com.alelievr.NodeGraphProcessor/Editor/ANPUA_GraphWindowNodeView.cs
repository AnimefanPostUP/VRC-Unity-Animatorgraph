...
namespace GraphProcessor
{
    ...
    public class ANPUA_GraphWindowNodeView : PinnedElementView
    {
        ANPUA_NodeProcessor processor;
        BaseGraphView graphView;

        public ANPUA_GraphWindowNodeView() => title = "Conditional Processor";

        protected override void Initialize(BaseGraphView graphView)
        {
            processor = new ANPUA_NodeProcessor(graphView.graph);
