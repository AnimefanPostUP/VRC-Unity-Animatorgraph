...
namespace GraphProcessor
{
	public class ToolbarView : VisualElement
	{
		...
		ToolbarButtonData showExternParameters;
		ToolbarButtonData showParameters;
		ToolbarButtonData showNodepanel;
		...
		public virtual void UpdateButtonStatus()
		{
			...
			if (showExternParameters != null)
				showExternParameters.value = graphView.GetPinnedElementStatus< ExposedParameterView >() != Status.Hidden;
		}
