...
public class ANPUA_NodeView_Condition : BaseNodeView
{
    ...
    public class ANPUA_ParameterListVisualElement : VisualElement
    {
        ...
        public void OpenModeMenu(ANPUA_ParameterType parameterType, ANPUA_ConditionContainer container, Button button)
        {
        ...
        public void AddModeMenuItem(GenericMenu menu, CompareEnum compareEnum, ANPUA_ConditionContainer container, Button button)
        {
        ...
        private void SelectMode(CompareEnum compareEnum, ANPUA_ConditionContainer container)
        {
        ...
        public void OpenParameterMenu(ANPUA_ConditionContainer container)
        {
        ...
        public void AddMenuItem(GenericMenu menu, string[] parts, int index, ANPUA_GenericParameter parameter, ANPUA_ConditionContainer containter)
        {
        ...
        private void SelectParameter(ANPUA_GenericParameter parameter, ANPUA_ConditionContainer conditionContainer)
        {
            //Set the Parameter in the Container
    ...
    public override void Enable()
    {
        ...
        Button addContainerButton = new Button(() =>
        {
            ...
            if (condition.conditionContainer == null) condition.conditionContainer = new ANPUA_ConditionContainer[0];
            Array.Resize<ANPUA_ConditionContainer>(ref condition.conditionContainer, condition.conditionContainer.Length + 1);
            //Initialize the new Container
            condition.conditionContainer[condition.conditionContainer.Length - 1] = new ANPUA_ConditionContainer();
