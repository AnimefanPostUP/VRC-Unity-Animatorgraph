...
namespace GraphProcessor
{
	...
	public class BaseGraph : ScriptableObject, ISerializationCallbackReceiver
	{
		...
		[SerializeField, SerializeReference]
		public List<ANPUA_GenericParameter> parameters = new List<ANPUA_GenericParameter>();
		...
		public event Action onParameterListChanged;
		public event Action<ExposedParameter> onExposedParameterModified;
		public event Action<ANPUA_GenericParameter> onParameterModified;
...
#pragma warning restore CS0618
		...
		public string AddParameter(string name, ANPUA_ParameterType type, object value = null)
		{



			var param = new ANPUA_GenericParameter(ANPUA_ParameterSyncState.Synch, ANPUA_ParameterState.Unsaved, type, value);
		...
		//for Parameters
		public void RemoveParameter(ANPUA_GenericParameter parameter)
		{
			parameters.Remove(parameter);

			onParameterListChanged?.Invoke();
		}

		public void RemoveParameter(string guid)
		{
			if (parameters.RemoveAll(e => e.guid == guid) != 0)
				onParameterListChanged?.Invoke();
		}
		...
		public void UpdateParameterName(ANPUA_GenericParameter parameter, string name)
		{
			parameter.name = name;
			onParameterModified?.Invoke(parameter);
		}
